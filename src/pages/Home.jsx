      ...
      <Row className='m-5'>
        {
          response?.length > 0 ?
                ...
                <Card style={{ width: '18rem' }}>
                  ...
                  <Card.Body>
                    ...
                    <div className='d-flex align-items-center justify-content-evenly'>
                      <Button className='w-50 me-2' variant="outline-danger" onClick={() => dispatch(addtoWhishList(item))}>
                        <i className="fa-solid fa-heart me-2 "></i>
                      </Button>
                      <Button className='w-50' variant="outline-success" onClick={() => dispatch(addToCart(item))}>
            ...
            <div className='d-flex align-items-center justify-content-center flex-column '>
              <img src="https://i.gifer.com/ZKZg.gif" alt="" width={'200px'} />
              <h6>LOADING....</h6>
            </div>
